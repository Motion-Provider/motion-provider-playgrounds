...
export default [
  "Welcome to Motion Text Playground 🚀, here you will explore the dynamic capabilities of Motion Text and the playground.",
  ...
  "We recommend using 'linear' or relevant delay algorithm rather than others for smooth and sequenced animation effects.",
